...
// Material Symbols Rounded — local_cafe. Generated by scripts/gen-icons.mjs.
export function LocalCafe(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
